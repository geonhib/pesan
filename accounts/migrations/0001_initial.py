    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.CharField(blank=True, choices=[('national', 'national'), ('passport', 'passport')], default='national', max_length=20)),
                ('id_number', models.CharField(blank=True, max_length=20, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(9), django.core.validators.MaxLengthValidator(14)])),
                ...
                ('employer_type', models.CharField(blank=True, choices=[('self-employment', 'self-employment'), ('organization', 'organization')], default='organization', max_length=60)),
